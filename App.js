...
const colors = ["#F7DC7F", "#A2D9CE", "#D7BDE2"];
...
export default function App() {
  ...
  async function playAlarm(){
    const { sound } = await Audio.Sound.createAsync(
      require("./assets/alarm-clockFinish.mp3")
    );
    await sound.playAsync();
  }
    ...
    <SafeAreaView style={[
      ...
      <View style={{ 
        ...
        <Header 
          ...
          setTime={setTime} />
        <Timer time={time} />
        <TouchableOpacity onPress={handeStartStop} style={styles.button}>
